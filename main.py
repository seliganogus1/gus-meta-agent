...
from langchain_pinecone import Pinecone as LangchainPinecone  # ✅ nova importação correta
from langchain_openai import OpenAIEmbeddings  # atualizado também
...
# Inicializa cliente Pinecone (novo padrão)
pc = Pinecone(api_key=PINECONE_API_KEY)
index = pc.Index(PINECONE_INDEX)

# Cria vectorstore com nova classe compatível
